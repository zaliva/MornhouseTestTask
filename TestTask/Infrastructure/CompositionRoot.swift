...
class CompositionRootImpl {
    ...
    func resolveDescriptionViewController(factModel: FactModel) -> DescriptionViewController {
        let vc = DescriptionViewController.instantiateFromStoryboard("DescriptionViewController")
        vc.viewModel = DescriptionViewModel(view: vc, factModel: factModel)
        return vc
    }
}
